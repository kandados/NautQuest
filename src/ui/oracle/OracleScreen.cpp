...
static void backButtonEventHandler(lv_event_t *event)
{
    ...
    {
        Serial.println("[OracleScreen] Volver pulsado");
        NQNavigation.goBack();
    }
}

void OracleScreen::show()
{
    ...
    lv_label_set_text(title, "Oraculo");
    ...
    lv_label_set_text(message,
                      "Aqui, el oraculo de NautQuest\n"
                      "te ayudara a decidir\n"
                      "tu siguiente paso.");

...
static void testCameraButtonEventHandler(lv_event_t *event)
{
    ...
    Serial.println("[DeveloperScreen] Enviando PING al modulo camara");
...
void DeveloperScreen::show()
{
    ...
    lv_obj_align(missions, LV_ALIGN_CENTER, 0, -75);
    ...
    lv_obj_align(experience, LV_ALIGN_CENTER, 0, -35);
    ...
    lv_obj_align(system, LV_ALIGN_CENTER, 0, 5);
    ...
    lv_obj_align(hardware, LV_ALIGN_CENTER, 0, 45);

    lv_obj_t *testCameraButton = lv_btn_create(lv_scr_act());
    lv_obj_set_size(testCameraButton, 190, 38);
    lv_obj_align(testCameraButton, LV_ALIGN_CENTER, 0, 92);
    ...
    lv_obj_set_style_text_font(testCameraLabel, &lv_font_montserrat_16, 0);
    ...
    lv_obj_align(cameraStatusLabel, LV_ALIGN_CENTER, 0, 125);

    lv_obj_t *backButton = lv_btn_create(lv_scr_act());
    lv_obj_set_style_bg_color(backButton, NQTheme.backButton(), 0);
    lv_obj_set_size(backButton, 180, 38);
    lv_obj_align(backButton, LV_ALIGN_CENTER, 0, 170);
